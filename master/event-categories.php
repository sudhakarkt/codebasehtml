...
<body>
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 30%;">Event Category Name</th>
                                        <th style="width:9%" class="text-right"><a href="javascript:void(0);" data-toggle="modal" data-target="#AddEventCategories" title="Add"><img src="../images/add-item.svg" width="25" /></a></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
    ...
    <!-- Add Event Categories Modal -->
    <div class="modal fade" id="AddEventCategories" tabindex="-1" role="dialog" aria-labelledby="AddEventCategoriesLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="AddEventCategoriesLabel">Add Event Category</h5>
